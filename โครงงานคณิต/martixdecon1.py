...
plt.savefig('blurred_gaussian.png')  # Save the Gaussian-blurred image

plt.subplot(163)
plt.title('Median Blur')
plt.imshow(blurred_median, cmap='gray')
plt.savefig('blurred_median.png')  # Save the median-blurred image

plt.subplot(164)
plt.title('Deblurred (Gaussian)')
plt.imshow(deblurred_gaussian, cmap='gray')
plt.savefig('deblurred_gaussian.png')  # Save the deblurred Gaussian image

plt.subplot(165)
plt.title('Deblurred (Median)')
plt.imshow(deblurred_median, cmap='gray')
plt.savefig('deblurred_median.png')  # Save the deblurred median image
